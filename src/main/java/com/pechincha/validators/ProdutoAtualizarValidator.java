...
public class ProdutoAtualizarValidator implements ConstraintValidator<ProdutoAtualizar, ProdutoDTOAtualizar> {
	...
	@Override
	public void initialize(ProdutoAtualizar ann) {
	}

	@Override
	public boolean isValid(ProdutoDTOAtualizar objDto, ConstraintValidatorContext context) {
