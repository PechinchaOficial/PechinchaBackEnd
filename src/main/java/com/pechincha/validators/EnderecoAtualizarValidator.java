...
public class EnderecoAtualizarValidator implements ConstraintValidator<EnderecoAtualizar, EnderecoDTOAtualizar> {
	...
	@Override
	public void initialize(EnderecoAtualizar ann) {
	}

	@Override
	public boolean isValid(EnderecoDTOAtualizar objDto, ConstraintValidatorContext context) {
